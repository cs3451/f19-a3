...
module Surfaces {
    export var shiny: rt.Surface = {
        diffuse: function(pos) { return rt.Color.white; },
        specular: function(pos) { return rt.Color.grey; },
        reflect: function(pos) { return 0.7; },
        roughness: 250
    }
    export var checkerboard: rt.Surface = {
        diffuse: function(pos: rt.Vector) {
...
function defaultScene(): rt.Scene {
    return {
...
function exec() {
    ...
    var sphere = <rt.Sphere>scene.things[1];
